				...
				<header className="mb-5 rounded border border-slate-700/80 bg-slate-950/70 p-4 shadow-2xl shadow-black/30 backdrop-blur">
					<div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
						<div>
							...
							<p className="mt-2 max-w-3xl text-sm text-slate-300 sm:text-base">Click the slanted level bars to set the weapon level. Gray means unbought, red marks the next upgrade, and orange means bought/complete.</p>
						</div>
